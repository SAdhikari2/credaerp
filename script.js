                 ...
                 modalContent.innerHTML = `
                     ...
                     <div style="text-align: center; padding: 1.5rem 0 0.5rem 0;">
                         ...
                         <div style="display: flex; flex-direction: column; gap: 0.75rem; margin-bottom: 1.75rem; text-align: left;">
                             <a href="https://github.com/SAdhikari2/medicines-catalog/releases/latest/download/CredaERP-Windows.exe" class="cta-btn cta-btn-primary" style="text-align: center; padding: 0.75rem 1rem; font-size: 0.9rem;">🖥️ Download for Windows (.exe)</a>
                             <a href="https://github.com/SAdhikari2/medicines-catalog/releases/latest/download/CredaERP-macOS-AppleSilicon.dmg" class="cta-btn cta-btn-secondary" style="text-align: center; padding: 0.75rem 1rem; font-size: 0.9rem;">🍏 Download for macOS (Apple Silicon M1/M2/M3)</a>
                             <a href="https://github.com/SAdhikari2/medicines-catalog/releases/latest/download/CredaERP-macOS-Intel.dmg" class="cta-btn cta-btn-secondary" style="text-align: center; padding: 0.75rem 1rem; font-size: 0.9rem;">💻 Download for macOS (Intel Chip)</a>
                         </div>
